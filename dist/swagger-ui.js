...
HeaderView = (function(superClass) {
  ...
  HeaderView.prototype.showSelectedApi = function(e) {
    var selectedText;
    selectedText = $('#select_baseUrl option').filter(':selected').text();
    if (selectedText === "Other") {
      return this.showInputTextBox();
    } else {
      if (e != null) {
        e.preventDefault();
      }
  ...
  HeaderView.prototype.showInputTextBox = function() {
    $('#select_baseUrl').hide();
    $('#input_baseUrl').show();
    return $('#chooseFromList').show();
  };

  HeaderView.prototype.showDropDown = function() {
    $('#input_baseUrl').hide();
    $('#select_baseUrl').show();
    return $('#chooseFromList').hide();
  };
